...
const CustomizeProducts = ({
    ...
    return (
        <div className="flex flex-col gap-6">
                    ...
                    <ul className="flex items-center gap-3">
                        {option.choices?.map((choice) => {
                            ...
                            return option.name === "Колір" ? (
                                ...
                                <li
                                    key={choice.value}
                                    className="ring-1 ring-notification text-notification rounded-md py-1 px-4 text-sm"
                                    style={{
                                        cursor: disabled ? "not-allowed" : "pointer",
            ...
            <ul className="flex items-center gap-3">
                <li className="ring-1 ring-notification text-notification rounded-md py-1 px-4 text-sm cursor-pointer">
                    Small
                </li>
