...
const Footer = () => {
    return (
        <div className="py-24 px-4 md:px-16 xl:px-32 2xl:px-64 bg-gray-100 text-sm mt-24">
            {/* TOP */}
            <div className="flex flex-col md:flex-row justify-between gap-24">
                ...
                <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
                    ...
                    <span className="font-semibold">hello@vexer79.dev</span>
                ...
                <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
                    ...
                    <div className="flex">
                        ...
                        <button className="w-1/4 bg-notification text-white">JOIN</button>
                    </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
                <div className="">© 2024 Vexer79 Shop</div>
